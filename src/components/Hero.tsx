...
function Hero() {
	return (
		<div className="px-20 pt-20 flex justify-start items-start flex-col">
			...
			<p className="text-white mt-5 w-3/4 text-montserrat font-normal lg:text-sm md:text-xs text-xs">
			...
			<div className="absolute bottom-0 right-5 w-full flex justify-end items-end flex-nowrap pointer-events-none	">
